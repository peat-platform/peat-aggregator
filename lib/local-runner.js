...
var config = {
   ...
   mongrel_handler : {
      source : { spec:'tcp://127.0.0.1:49923', id:'e', bind:false, type:'pull', isMongrel2:true, error_handle:'tcp://127.0.0.1:49904' },
      sink   : { spec:'tcp://127.0.0.1:49924', id:'f', bind:false, type:'pub',  isMongrel2:true }
   },
   logger_params : {
